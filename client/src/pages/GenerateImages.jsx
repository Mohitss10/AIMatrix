...
const GenerateImages = () => {
  ...
  // ✅ Collapse left column after image generated (mobile only)
  useEffect(() => {
    ...
    <div className="flex-1 overflow-y-auto scrollbar-hide">
          ...
          className={`flex-1 w-full max-w-full p-5 bg-slate-700/10 backdrop-blur-sm rounded-2xl border border-white/10 
            ...
            ${
              showLeftCol
                ...
                : "max-h-16 overflow-hidden opacity-80 lg:max-h-full lg:opacity-100"
            }`}
        >
          <div className="flex items-center justify-between">
            ...
            <svg
              ...
              className={`w-4 h-4 cursor-pointer transition-transform duration-300 lg:hidden ${
                showLeftCol ? "rotate-180" : ""
              }`}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
      ...
      <div className="mt-6 p-6 bg-slate-700/10 border border-white/10 rounded-xl hidden sm:block">
        ...
        <p className="text-sm mb-2">
          Create high-quality, unique images instantly using our AI image
          generator — perfect for art, design projects, social media, and
          marketing.
        </p>
      </div>
    </div>
